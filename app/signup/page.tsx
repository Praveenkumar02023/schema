    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 text-white flex items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-zinc-900/50 backdrop-blur-xl rounded-2xl border border-zinc-800 p-8 shadow-2xl">
          <h1 className="text-2xl font-bold mb-2 text-center">Get started free</h1>
          <p className="text-zinc-400 text-center mb-8">Start designing database schemas today</p>
          ...
          <div className="mt-8 space-y-3">
            ...
            <div className="flex items-center gap-3 text-sm text-zinc-400">
              ...
              <span>Unlimited schemas and tables</span>
            </div>
            <div className="flex items-center gap-3 text-sm text-zinc-400">
              <svg className="w-5 h-5 text-green-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span>Export to SQL, JSON, and more</span>
            </div>
            <div className="flex items-center gap-3 text-sm text-zinc-400">
              <svg className="w-5 h-5 text-green-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
